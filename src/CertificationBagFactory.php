...
class CertificationBagFactory
{
    ...
    {
        $private_key = dirname(__FILE__) . '/certs/webpay-captura-diferida/597020000546.key';
        $client_certificate = dirname(__FILE__) . '/certs/webpay-captura-diferida/597020000546.crt';
